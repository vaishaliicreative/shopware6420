...
class ICTECHBackendLoginByOTP extends Plugin
{
     ...
     * @return void
     */
    public function createEmailTemplateForBackendLoginOTP(InstallContext $installContext){
        ...
        $customMailTemplateType = $mailTemplateTypeRepository->search(
            (new Criteria())->addFilter(new EqualsFilter('technicalName',self::TEMPLATE_TYPE_TECHNICAL_NAME)),$installContext->getContext()
        )->first();
     ...
     * @return void
     */
    public function destroyEmailTemplateForBackendLoginOTP(UninstallContext $uninstallContext){
        /** @var
         * EntityRepositoryInterface $mailTemplateTypeRepository
         */
        $mailTemplateTypeRepository = $this->container->get('mail_template_type.repository');
        ...
        $customMailTemplateType = $mailTemplateTypeRepository->search(
            (new Criteria())->addFilter(new EqualsFilter('technicalName',self::TEMPLATE_TYPE_TECHNICAL_NAME)),$uninstallContext->getContext()
        )->first();
