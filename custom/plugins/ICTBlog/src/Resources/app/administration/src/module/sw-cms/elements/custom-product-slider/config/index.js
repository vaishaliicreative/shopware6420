...
Component.register('sw-cms-el-config-custom-product-slider',{
    ...
    computed: {
        ...
        productAssignmentTypes() {
            return [{
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productAssignmentTypeOptions.manual'),
                value: 'static',
            }, {
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productAssignmentTypeOptions.productStream'),
        ...
        productStreamSortingOptions() {
            return [{
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productStreamSortingOptions.nameAsc'),
                value: 'name:ASC',
            }, {
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productStreamSortingOptions.nameDesc'),
                value: 'name:DESC',
            }, {
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productStreamSortingOptions.creationDateAsc'),
                value: 'createdAt:ASC',
            }, {
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productStreamSortingOptions.creationDateDesc'),
                value: 'createdAt:DESC',
            }, {
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productStreamSortingOptions.random'),
                value: 'random',
            }, {
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productStreamSortingOptions.priceAsc'),
                value: 'cheapestPrice:ASC',
            }, {
                label: this.$tc('sw-cms-text-blog.elements.customProductSlider.config.productStreamSortingOptions.priceDesc'),
