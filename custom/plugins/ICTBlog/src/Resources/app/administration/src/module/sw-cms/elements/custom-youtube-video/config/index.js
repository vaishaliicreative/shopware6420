import template  from "./sw-cms-el-config-custom-youtube-video.html.twig";
import './sw-cms-el-config-custom-youtube-video.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-config-custom-youtube-video', {
    template,
