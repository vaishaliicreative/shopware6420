import template from './sw-cms-el-custom-youtube-video.html.twig';
import './sw-cms-el-custom-youtube-video.scss';

const { Component,Mixin} = Shopware;

Component.register('sw-cms-el-custom-youtube-video',{
    template,
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('custom-youtube-video');
            this.initElementData('custom-youtube-video');
        },
    },
});
