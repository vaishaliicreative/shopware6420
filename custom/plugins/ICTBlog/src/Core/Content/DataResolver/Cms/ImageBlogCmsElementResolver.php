...
#[Package('content')]
class ImageBlogCmsElementResolver extends AbstractCmsElementResolver
{
    ...
    private function addMediaEntity(CmsSlotEntity $slot,ImageStruct $image,ElementDataCollection $result,FieldConfig $config,ResolverContext $resolverContext)
    {
