...
class CustomProductSliderCmsElementResolver extends AbstractCmsElementResolver
{
    ...
    private const STATIC_SEARCH_KEY = 'custom-product-slider';
    ...
    /**
     * @param ProductSliderStruct $slider
     * @param ElementDataCollection $result
    ...
    /**
     * @param EntityResolverContext $resolverContext
     ...
     * @param ResolverContext $resolverContext
     * @param FieldConfig $config
     * @param FieldConfigCollection $elementConfig
     * @return Criteria
     * @throws \Exception
     */
